...
const paths = ["", "/invert-image", "/grayscale-image", "/jpg-to-png", "/png-to-jpg", "/resize-image", "/compress-image", "/make-background-transparent", "/image-size-calculator", "/about", "/privacy", "/terms"];
